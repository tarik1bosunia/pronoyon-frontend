    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      <div className="container mx-auto px-4 py-12">
        <div className="flex flex-col lg:flex-row lg:items-start lg:justify-center gap-8 lg:gap-12">
          {/* Login Card - Left Side on Desktop */}
          <div className="w-full lg:w-[440px] flex-shrink-0">
            {/* Card Container */}
            <div className="bg-white rounded-3xl shadow-xl p-8 space-y-6 sticky top-12">
              {/* Header */}
          ...
          {/* Key Features - Right Side on Desktop, Hidden on Mobile */}
      ...
      {/* Floating Features Button - Mobile Only */}
